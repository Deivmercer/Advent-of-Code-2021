def search_path(current_vertex, current_path, twice):
    ...
    for destination_vertex in arcs[current_vertex]:
        ...
        if destination_vertex == "end":
            ...
            search_path(destination_vertex, new_path, twice)
        elif destination_vertex.islower() and destination_vertex in current_path and twice \
                and current_path.count(destination_vertex) == 1:
            search_path(destination_vertex, new_path, False)
...
for starting_vertex in arcs["start"]:
    ...
    search_path(starting_vertex, path.copy(), True)
print(len(path_list))
